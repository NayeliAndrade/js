...
function makeRequest(wordSearch) {
  fetch(
    `https://pixabay.com/api/?key=28447089-bfc88bc737501f66f3560f214&q=${wordSearch}`
  )
...
function printInfo(data) {
  ...
  imagenes.map((imagen) => {
    ...
    <div class="containerImages">
            ...
            <a href="${pageURL}" target="_blank">Link de la imagen</a> <br>
            <span class="iconoLike" ><i onclick="changeColorRed()" class="fa-solid fa-thumbs-up"></i></span>
            <span class="iconoDislike" ><i onclick="changeColorPurple()" class="fa-solid fa-thumbs-down"></i></span>
        </div>
    `;
...
function changeColorRed(){
  ...
  let iconoDislike = document.querySelector(".iconoDislike");
  console.log("hola");
  iconoLike.style.color="red";
  iconoDislike.style.color="gray"
}
...
function changeColorPurple(){
  ...
  let iconoDislike = document.querySelector(".iconoDislike");
  console.log("hola2");
  iconoDislike.style.color="purple";
  iconoLike.style.color=""
}
